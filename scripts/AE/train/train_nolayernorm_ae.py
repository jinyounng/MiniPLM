"""
Conditional AutoEncoder for Knowledge Distillation (No LayerNorm in Decoder)
...
3. **Loss 함수**:
   ...
   - Logit KL Loss: Teacher의 logit 분포 보존
...
사용 예시:
----------
python train_nolayernorm_ae.py \
...
차이점:
-------
- 디코더의 마지막 LayerNorm이 제거됨 (원본 train_ae.py와 비교)
"""
...
class ConditionalAutoEncoder(nn.Module):
    ...
    def __init__(self, input_dim=1600, latent_dim=8, teacher_embed=None):
        ...
        # Decoder layers (마지막 LayerNorm 제거)
        decoder_layers = []
        ...
        # 마지막 LayerNorm 제거 (원본 train_ae.py와의 차이점)
...
def main():
    ...
    parser.add_argument("--alpha_logit", type=float, default=1.0,
                        help="Weight for logit KL divergence loss (default: 1.0)")
