#! /bin/bash
# Top-K KD 2stage: offline_kd (topk) initialized from 1stage AE-KD checkpoint
#
# Cached teacher logits + Top-K loss, student = 1stage epoch_1
...
# type
TYPE="offline_kd"
# model: 2stage = Top-K KD initialized from 1stage AE-KD checkpoint
CKPT_NAME="qwen/200M-2stage-topk-from-1stage"
...
WANDB_NAME="200M-topk-kd-2stage-from-1stage"
...
OPTS+=" --wandb-group offline_kd_topk"
